...
> Data is split by language. Java, JavaScript, C++, Go and Python datasets are available.

## Data tiers

| Tier | Path | Produced by | Verification |
| --- | --- | --- | --- |
| Core | `data/java/`, `data/javascript/`, `data/cpp/`, `data/go/`, `data/python/` | Sparrow SAST detection and annotation | Patches re-verified by the maintainers with Sparrow SAST |
